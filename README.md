...
[`protocol/merchant-api.md`](https://github.com/deepayment/sdk-go/blob/main/protocol/merchant-api.md#client-side-validation).
...
Full error-code table: [`protocol/errors.md`](https://github.com/deepayment/sdk-go/blob/main/protocol/errors.md).
...
[`protocol/`](https://github.com/deepayment/sdk-go/tree/main/protocol/) is the cross-language source of truth: the
